...
{
    public partial class frmSayımMain : DevExpress.XtraEditors.XtraForm
    {
        private DateTime lastInteractionTime;
        public static frmSayımMain Instance { get; private set; }
        public frmSayımMain()
        {
